/*
Copyright (C): 2023-2024, Intelek Education Solutions (IntelekEDU)
modified by Tony Ng
on Date 28 January 2023
*/

//% color="#ECA40D" weight=30 icon="\uf135"
namespace BuildBitV3 {
     ...
     * @param index
     */   
    //% blockId=Build:BitV3_RGB_Program block="RGB_Program"
    //% weight=99
    //% blockGap=10
    ...
    //% blockId=Build:BitV3_Music block="Music|%index"
    //% weight=98
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=Build:BitV3_Servo block="Servo(180°)|num %num|value %value"
    //% weight=97
    //% blockGap=10
    ...
    //% blockId=Build:BitV3_Servo2 block="Servo(270°)|num %num|value %value"
    //% weight=96
    //% blockGap=10
    ...
    //% blockId=Build:BitV3_Servo3 block="Servo(360°)|num %num|pos %pos|value %value"
    //% weight=96
    //% blockGap=10
    ...
    //% blockId=Build:BitV3_MotorRun block="Motor|%index|speed(-255~255) %speed"
    //% weight=93
    ...
    //% blockId=Build:BitV3_MotorRunDual block="Motor|%motor1|speed %speed1|%motor2|speed %speed2"
    //% weight=92
    //% blockGap=50
    ...
    //% blockId=Build:BitV3_MotorStopAll block="Motor Stop All"
    //% weight=91
    //% blockGap=50
...
namespace BuildBitV3_Digital {
    ...
    //% blockId=Build:BitV3_Digital_Ultrasonic block="Ultrasonic|pin %value_DNum"
    //% weight=97
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=Build:BitV3_Digital_IR block="IR|pin %value_DNum|value %value"
    //% weight=96
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=Build:BitV3_Digital_PIR block="PIR|pin %value_DNum|value %value"
    //% weight=96
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=Build:BitV3_Digital_Collision block="Collision|pin %value_DNum|value %value"
    //% weight=3
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=Build:BitV3_Digital_Button block="Button|pin %value_DNum|value %value"
    //% weight=3
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=Build:BitV3_Digital_Vibration block="Vibration|pin %value_DNum|get "
    //% weight=1
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
...
namespace BuildBitV3_Analog {
    ...
    //% blockId=Build:BitV3_Anaglog_Light block="Light|pin %value_ANum"
    //% weight=100
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5 
    ...
    //% blockId=Build:BitV3_Anaglog_Sound block="Sound|pin %value_ANum"
    //% weight=99
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
	...
	//% blockId=Build:BitV3_Anaglog_Potentiometer block="Potentiometer|pin %value_ANum"
    //% weight=2
    //% blockGap=20
    ...
    //% blockId=Build:BitV3_Anaglog_Rocker block="Rocker|pin %value_ANum|value %value"
    //% weight=1
    //% blockGap=20
...
namespace BuildBitV3_PWM {
    ...
    //% blockId=Build:BitV3_PWM_BuzzerPin block="Set Buzzer Pin|%value_DNum"
    //% weight=99
    //% blockGap=22
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=Build:BitV3_PWM_VibrationMot block="Vibration Motor|%value_DNum|speed %speed"
    //% weight=80
    //% blockGap=22
    ...
    //% blockId=Build:BitV3_PWM_RGB block="RGB|(P12P13P14)|value1 %value1|value2 %value2|value3 %value3"
    //% weight=2
    //% blockGap=20
    ...
    //% blockId=Build:BitV3_PWM_RGB2 block="RGB|(P12P13P14)|value %value"
    //% weight=1
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
